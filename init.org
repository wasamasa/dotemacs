...
#+BEGIN_SRC emacs-lisp
(defvar my-flycheck-mode-hooks
  '(python-mode-hook ruby-mode-hook LaTeX-mode-hook))

(dolist (hook my-flycheck-mode-hooks)
...
After doing this five times in a row I should be able to figure out a
