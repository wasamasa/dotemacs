...
To work around a bug present in the package I'm explicitly telling it
to use a less recent Ruby executable I've obtained from the AUR.

#+BEGIN_SRC emacs-lisp
(setq enh-ruby-program "ruby-2.1")
#+END_SRC
