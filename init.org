...
*** [[https://github.com/magnars/dash.el][d]]ash
...
*** [[http://elpa.gnu.org/packages/rainbow-mode.html][rainbow-mode]]

Highlights color identifiers with their respective color.
...
you to enter its content right away.  The following is stolen from [[https://github.com/Fuco1/smartparens/wiki/Permissions#pre-and-post-action-hooks][its
wiki]].
