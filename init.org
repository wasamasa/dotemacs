...
24.4 seem to be less wonky about it.
...
Its customization setup is twofold, first of all one needs to define a
regex encompassing all desired keywords.

#+BEGIN_SRC emacs-lisp
(setq hl-todo-regexp (regexp-opt '("TODO" "NOTE" "FIXME" "KLUDGE")))
#+END_SRC

The second part consists of assigning the =hl-todo= face to the
respective keywords.
