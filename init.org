...
24.4 seem to be less wonky about it.  Adapted from [[https://github.com/jorgenschaefer/circe/wiki/Configuration#fluid-width-windows][the wiki]].
...
#+BEGIN_SRC emacs-lisp
(setq hl-todo-regexp (concat "\\_<" (regexp-opt '("TODO" "NOTE" "FIXME" "KLUDGE") t) ":?\\_>"))
#+END_SRC
