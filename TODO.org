...
* Do a better job with the =C-i= hack for evil

It seems to work out initially, but is somehow reset to normal tab key
behaviour.  Re-evaluating it temporarily fixes it.  This is pretty
weird, I've got to find out what the hell is happening there.
