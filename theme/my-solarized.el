...
;;; external
   ...
   `(ediff-even-diff-A ((t (:background ,solarized-comments :foreground ,base3))))
   `(ediff-odd-diff-A ((t (:background ,solarized-comments :foreground ,base03))))
   `(ediff-even-diff-B ((t (:background ,solarized-comments :foreground ,base03))))
   `(ediff-odd-diff-B ((t (:background ,solarized-comments :foreground ,base3))))
