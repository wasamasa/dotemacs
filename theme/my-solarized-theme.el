...
(let* ((bg-3 (if my-solarized-dark? "#002b36" "#fdf6e3"))
       (bg-2 (if my-solarized-dark? "#073642" "#eee8d5"))
       (bg-1 (if my-solarized-dark? "#586e75" "#93a1a1"))
       (bg-0 (if my-solarized-dark? "#657b83" "#839496"))
       (fg-0 (if my-solarized-dark? "#839496" "#657b83"))
       (fg-1 (if my-solarized-dark? "#93a1a1" "#586e75"))
       (fg-2 (if my-solarized-dark? "#eee8d5" "#073642"))
       (fg-3 (if my-solarized-dark? "#fdf6e3" "#002b36"))
       (yellow-d  (if my-solarized-dark? "#7b6000" "#deb542"))
       (yellow    "#b58900")
       (yellow-l  (if my-solarized-dark? "#deb542" "#7b6000"))
       (orange-d  (if my-solarized-dark? "#8b2c02" "#f2804f"))
       (orange    "#cb4b16")
       (orange-l  (if my-solarized-dark? "#f2804f" "#8b2c02"))
       (red-d     (if my-solarized-dark? "#990a1b" "#ff6e64"))
       (red       "#dc322f")
       (red-l     (if my-solarized-dark? "#ff6e64" "#990a1b"))
       (magenta-d (if my-solarized-dark? "#93115c" "#f771ac"))
       (magenta   "#d33682")
       (magenta-l (if my-solarized-dark? "#f771ac" "#93115c"))
       (violet-d  (if my-solarized-dark? "#3f4d91" "#9ea0e5"))
       (violet    "#6c71c4")
       (violet-l  (if my-solarized-dark? "#9ea0e5" "#3f4d91"))
       (blue-d    (if my-solarized-dark? "#00629d" "#69b7f0"))
       (blue      "#268bd2")
       (blue-l    (if my-solarized-dark? "#69b7f0" "#00629d"))
       (cyan-d    (if my-solarized-dark? "#00736f" "#69cabf"))
       (cyan      "#2aa198")
       (cyan-l    (if my-solarized-dark? "#69cabf" "#00736f"))
       (green-d   (if my-solarized-dark? "#546e00" "#b4c342"))
       (green     "#859900")
       (green-l   (if my-solarized-dark? "#b4c342" "#546e00"))

       (solarized-fg fg-0)
       (solarized-bg bg-3)
       (solarized-hl bg-2)
       (solarized-emph fg-1)
       (solarized-comments bg-1)
  ...
  (custom-theme-set-faces
   ...
   `(my-circe-greentext-face ((t (:foreground ,green))))
   `(my-circe-highlight-notification-face ((t (:foreground ,fg-2 :weight bold))))
   `(comint-highlight-input ((t (:foreground unspecified))))
   `(comint-highlight-prompt ((t (:foreground unspecified))))
   `(eyebrowse-mode-line-active ((t (:foreground ,fg-2))))
   `(fixmee-notice-face ((t (:foreground ,red :weight bold :underline t))))
   ...
   `(lazy-highlight ((t (:foreground ,solarized-bg :background ,yellow :weight normal))))
   ...
   `(ecb-source-in-directories-buffer-face ((t (:inherit ecb-directories-general-face :foreground ,solarized-fg))))
   `(ecb-history-dead-buffer-face ((t (:inherit ecb-history-general-face :foreground ,solarized-comments))))
   `(ecb-directory-not-accessible-face ((t (:inherit ecb-directories-general-face :foreground ,solarized-comments))))
   `(ecb-bucket-node-face ((t (:inherit ecb-default-general-face :weight normal :foreground ,blue))))
   ...
   `(ecb-tree-guide-line-face ((t (:inherit ecb-default-general-face :foreground ,solarized-hl :height 1.0))))
   ...
   `(mode-line ((t (:foreground ,s-mode-line-fg :background ,s-mode-line-bg :box (:line-width 1 :color ,s-mode-line-bg)))))
   `(mode-line-buffer-id ((t (:foreground ,s-mode-line-buffer-id-fg :weight bold))))
   `(mode-line-highlight ((t (:box (:style border)))))
   `(mode-line-inactive ((t (:foreground ,s-mode-line-inactive-fg :background ,s-mode-line-inactive-bg :box (:line-width 1 :color ,s-mode-line-inactive-bc)))))
   `(header-line ((t (:foreground ,solarized-emph :background ,solarized-hl :box (:line-width 1 :color ,solarized-hl)))))
...
;;; external
     ...
     ;; ace-jump-mode
   `(ace-jump-face-background ((t (:foreground ,solarized-comments :background ,solarized-bg :inverse-video nil))))
   `(ace-jump-face-foreground ((t (:foreground ,red :background ,solarized-bg :inverse-video nil :weight bold))))
   ...
   `(cfw:face-disable ((t (:inherit cfw:face-day-title :foreground ,solarized-comments))))
   `(cfw:face-grid ((t (:foreground ,solarized-comments))))
   `(cfw:face-header ((t (:foreground ,blue-l :background ,blue-d :weight bold))))
   `(cfw:face-holiday ((t (:background unspecified :foreground ,red :weight bold))))
   ...
   `(cfw:face-today ((t (:weight bold :background ,solarized-hl :foreground unspecified))))
   `(cfw:face-today-title ((t (:background ,yellow-d :foreground ,yellow-l :weight bold))))
   `(cfw:face-toolbar ((t (:background ,solarized-hl :foreground ,solarized-fg))))
   `(cfw:face-toolbar-button-off ((t (:background ,yellow-d :foreground ,yellow-l :weight bold))))
   `(cfw:face-toolbar-button-on ((t (:background ,yellow-l :foreground ,yellow-d :weight bold))))

   ;; circe
   `(lui-irc-colors-bg-0-face ((t (:background ,fg-2))))
   `(lui-irc-colors-bg-1-face ((t (:background ,bg-2))))
   ...
   `(lui-irc-colors-bg-14-face ((t (:background ,bg-1))))
   `(lui-irc-colors-bg-15-face ((t (:background ,fg-1))))

   `(lui-irc-colors-fg-0-face ((t (:foreground ,fg-2))))
   `(lui-irc-colors-fg-1-face ((t (:foreground ,bg-2))))
   ...
   `(lui-irc-colors-fg-14-face ((t (:foreground ,bg-1))))
   `(lui-irc-colors-fg-15-face ((t (:foreground ,fg-1))))

   `(lui-button-face ((t (:foreground ,blue :underline t))))
   `(lui-highlight-face ((t (:foreground ,fg-2))))
   `(lui-time-stamp-face ((t (:foreground ,violet-d :weight bold))))

   `(circe-originator-face ((t (:foreground ,fg-2))))
   `(circe-prompt-face ((t (:foreground ,blue :background ,solarized-bg))))
   `(circe-server-face ((t (:foreground ,blue))))
   `(circe-highlight-nick-face ((t (:foreground ,fg-2 :weight bold))))
   ...
   ;; ctable
   `(ctbl:face-cell-select ((t (:background ,solarized-hl :foreground ,solarized-emph :underline ,solarized-emph :weight bold))))
   `(ctbl:face-continue-bar ((t (:background ,solarized-hl :foreground ,yellow))))
   `(ctbl:face-row-select ((t (:background ,solarized-hl :foreground ,solarized-fg :underline t))))
   ...
   `(diff-file-header ((t (:background ,solarized-bg :foreground ,solarized-fg :weight bold))))
   ...
   `(ediff-even-diff-A ((t (:background ,solarized-comments :foreground ,fg-3))))
   `(ediff-odd-diff-A ((t (:background ,solarized-comments :foreground ,bg-3))))
   `(ediff-even-diff-B ((t (:background ,solarized-comments :foreground ,bg-3))))
   `(ediff-odd-diff-B ((t (:background ,solarized-comments :foreground ,fg-3))))
   ...
   ;; epc
   `(epc:face-title ((t (:foreground ,blue :background ,solarized-bg :weight normal :underline nil))))
   ...
   ;; fic
   `(fic-author-face ((t (:background ,solarized-bg :foreground ,orange :underline t :slant italic))))
   `(fic-face ((t (:background ,solarized-bg :foreground ,orange :weight normal :slant italic))))
   `(font-lock-fic-face ((t (:background ,solarized-bg :foreground ,orange :weight normal :slant italic))))

   ;; flx
   `(flx-highlight-face ((t (:foreground ,blue :weight normal :underline nil))))
   ...
   `(flycheck-fringe-error ((t (:foreground ,red-l :weight bold))))
   `(flycheck-fringe-warning ((t (:foreground ,yellow-l :weight bold))))
   `(flycheck-fringe-info ((t (:foreground ,blue-l :weight bold))))
   ...
   ;; git-gutter
   `(git-gutter:added ((t (:background ,green :foreground ,solarized-bg :weight bold))))
   `(git-gutter:deleted ((t (:background ,red :foreground ,solarized-bg :weight bold))))
   `(git-gutter:modified ((t (:background ,blue :foreground ,solarized-bg :weight bold))))
   `(git-gutter:unchanged ((t (:background ,solarized-hl :foreground ,solarized-bg :weight bold))))
   ...
   `(helm-candidate-number ((t (:background ,solarized-hl :foreground ,solarized-emph :bold t))))
   ...
   `(helm-ff-invalid-symlink ((t (:background ,solarized-bg :foreground ,orange :slant italic))))
   ...
   `(helm-selection-line ((t (:background ,solarized-hl :foreground ,solarized-emph :underline nil))))
   `(helm-separator ((t (:foreground ,red))))
   `(helm-source-header ((t (:family mono :weight bold :height 1.0 :background ,blue-d :foreground ,solarized-bg))))
   ...
   `(hi-black-b ((t (:foreground ,solarized-emph :background ,solarized-bg :weight bold))))
   ...
   `(hi-black-hb ((t (:foreground ,solarized-emph :background ,solarized-bg :weight bold))))
   ...
   `(magit-log-head-label-bisect-bad ((t (:background ,red-l :foreground ,red-d :box 1))))
   `(magit-log-head-label-bisect-good ((t (:background ,green-l :foreground ,green-d :box 1))))
   `(magit-log-head-label-default ((t (:background ,solarized-hl :box 1))))
   `(magit-log-head-label-local ((t (:background ,blue-d :foreground ,blue-l :box 1))))
   `(magit-log-head-label-patches ((t (:background ,red-d :foreground ,red-l :box 1))))
   `(magit-log-head-label-remote ((t (:background ,green-d :foreground ,green-l :box 1))))
   `(magit-log-head-label-tags ((t (:background ,yellow-d :foreground ,yellow-l :box 1))))
   ...
   `(moccur-edit-done-face ((t (:foreground ,solarized-comments :background ,solarized-bg :slant italic))))
   `(moccur-edit-face ((t (:background ,yellow :foreground ,solarized-bg))))
   `(moccur-edit-file-face ((t (:background ,solarized-hl))))
   `(moccur-edit-reject-face ((t (:foreground ,red))))
   `(moccur-face ((t (:background ,solarized-hl :foreground ,solarized-emph :weight bold))))
   `(search-buffers-face ((t (:background ,solarized-hl :foreground ,solarized-emph :weight bold))))
   `(search-buffers-header-face ((t (:background ,solarized-hl :foreground ,yellow :weight bold))))
   ...
   ;; org-mode
   `(org-agenda-structure ((t (:foreground ,solarized-emph :background ,solarized-hl :weight bold :slant normal :inverse-video nil :underline nil :box (:line-width 2 :color ,solarized-bg)))))
   `(org-agenda-calendar-event ((t (:foreground ,solarized-emph))))
   `(org-agenda-calendar-sexp ((t (:foreground ,solarized-fg :slant italic))))
   `(org-agenda-date ((t (:foreground ,solarized-comments :background ,solarized-bg :weight normal :inverse-video nil :overline nil :slant normal :height 1.0 :box (:line-width 2 :color ,solarized-bg)))) t)
   `(org-agenda-date-weekend ((t (:inherit org-agenda-date :inverse-video nil :background unspecified :foreground ,solarized-comments :weight unspecified :underline t :overline nil :box unspecified))) t)
   `(org-agenda-date-today ((t (:inherit org-agenda-date :inverse-video t :weight bold :underline unspecified :overline nil :box unspecified :foreground ,blue :background ,solarized-bg))) t)
   ...
   `(org-column ((t (:background ,solarized-hl :strike-through nil :underline nil :slant normal :weight normal :inherit default))))
   ...
   `(sp-show-pair-match-face ((t (:foreground ,violet :background ,solarized-bg :weight normal :inverse-video t))))
   `(sp-show-pair-mismatch-face ((t (:foreground ,red :background ,solarized-bg :weight normal :inverse-video t))))

   ;; show-paren
   `(show-paren-match ((t (:foreground ,cyan :background ,solarized-bg :weight normal :inverse-video t))))
   `(show-paren-mismatch ((t (:foreground ,red :background ,solarized-bg :weight normal :inverse-video t))))

   ;; mic-paren
   `(paren-face-match ((t (:foreground ,cyan :background ,solarized-bg :weight normal :inverse-video t))))
   `(paren-face-mismatch ((t (:foreground ,red :background ,solarized-bg :weight normal :inverse-video t))))
   `(paren-face-no-match ((t (:foreground ,red :background ,solarized-bg :weight normal :inverse-video t))))
   ...
   `(speedbar-selected-face ((t (:inherit fixed-pitch :foreground ,yellow :underline t))))
   `(speedbar-separator-face ((t (:inherit fixed-pitch :background ,blue :foreground ,solarized-bg :overline ,cyan-d))))
   ...
   ;; term
   `(term-color-black ((t (:foreground ,bg-3 :background ,bg-2))))
   ...
   `(term-color-white ((t (:foreground ,bg-0 :background ,fg-0))))
   '(term-default-fg-color ((t (:inherit term-color-white))))
   '(term-default-bg-color ((t (:inherit term-color-black))))

   ;; tuareg
   `(tuareg-font-lock-governing-face ((t (:foreground ,magenta :weight bold))))
   `(tuareg-font-lock-multistage-face ((t (:foreground ,blue :background ,solarized-hl :weight bold))))
   `(tuareg-font-lock-operator-face ((t (:foreground ,solarized-emph))))
   `(tuareg-font-lock-error-face ((t (:foreground ,yellow :background ,red :weight bold))))
   `(tuareg-font-lock-interactive-output-face ((t (:foreground ,cyan))))
   `(tuareg-font-lock-interactive-error-face ((t (:foreground ,red))))

   ;; undo-tree
   `(undo-tree-visualizer-default-face ((t (:foreground ,solarized-comments :background ,solarized-bg))))
   ...
   `(undo-tree-visualizer-active-branch-face ((t (:foreground ,solarized-emph :background ,solarized-bg :weight bold))))
   ...
   `(web-mode-current-element-highlight-face ((t (:underline unspecified :weight unspecified :background ,solarized-hl))))
   `(web-mode-css-at-rule-face ((t (:foreground ,violet :slant italic))))
   `(web-mode-css-pseudo-class-face ((t (:foreground ,green :slant italic))))
   `(web-mode-doctype-face ((t (:foreground ,solarized-comments :slant italic :weight bold))))
   ...
   ;; whitespace-mode
   `(whitespace-space ((t (:background unspecified :foreground ,solarized-comments :inverse-video unspecified :slant italic))))
   `(whitespace-hspace ((t (:background unspecified :foreground ,solarized-emph :inverse-video unspecified))))
   `(whitespace-tab ((t (:background unspecified :foreground ,red :inverse-video unspecified :weight bold))))
   `(whitespace-newline ((t(:background unspecified :foreground ,solarized-comments :inverse-video unspecified))))
   `(whitespace-trailing ((t (:background unspecified :foreground ,orange-d :inverse-video t))))
   `(whitespace-line ((t (:background unspecified :foreground ,magenta :inverse-video unspecified))))
   `(whitespace-space-before-tab ((t (:background ,red-d :foreground unspecified :inverse-video unspecified))))
   `(whitespace-indentation ((t (:background unspecified :foreground ,yellow :inverse-video unspecified :weight bold))))
   `(whitespace-empty ((t (:background unspecified :foreground ,red-d :inverse-video t))))
